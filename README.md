...
| Figure | Varied hyperparameter | Description |
|------|----------------------|-------------|
| Fig. 5 | Ensemble size | Non-monotonic error behavior due to conditioning of ensemble covariances |
| Fig. 6 | RBF shape parameter $\eta$ | Effect of kernel width on reconstruction accuracy |
| Fig. 7 | Prior mean shifting | Sensitivity to bias in prior parameter mean |
| Fig. 8 | Prior covariance scaling $\kappa$ | Effect of prior uncertainty magnitude |
| Fig. 9 | Time step $\Delta t$ | Temporal resolution vs. assimilation stability |
| Fig. 10 | Observation span | Effect of measurement window length |
