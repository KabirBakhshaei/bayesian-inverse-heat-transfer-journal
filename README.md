...
This repository provides all the necessary code and data to reproduce the results presented in our paper entitled **Optimized Bayesian Framework for Inverse Heat Transfer Problems Using Reduced Order Methods**.

Published in *Computational Science and Engineering* (2026):  
https://doi.org/10.1007/s44207-026-00009-8  

Preprint version available at:  
https://arxiv.org/abs/2402.19381  
